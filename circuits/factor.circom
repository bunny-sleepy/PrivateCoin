...
// The first this to know is that all circuits have signals (wires in the
...
// `circom` will synthesize. We distinguish between public and private signals
//  when defining the main component. This is done by providing the list of 
//  public input signals. In this case, the product signal is public.
